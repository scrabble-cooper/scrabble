...
We took a WORKING spring boot project and completely changed it bit by bit to meet our projects needs. Trying to create a spring boot project from nil proved very difficult and frustrating. As supposedly working projects often failed. Usually due to the version of spring boot.
